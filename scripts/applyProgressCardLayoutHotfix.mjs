...
console.log('Doppelter Comms-Fortschrittsbalken entfernt.');
...
.pgt-overview-card-unified > .comms-section-card-progress,
.pgt-overview-card-unified .comms-section-card-progress:not(.pgt-progress-card-section) {
